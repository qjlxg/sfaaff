...
TEST_IP_LIMIT = 50                        # 每个 IP 源最多取多少个（建议 30~80）
TEST_PORTS = [443,80,]                        # 强烈建议先只测 443，成功率最高
# TEST_PORTS = [443, 80, 8443, 2053]      # 需要多端口时再打开

MAX_NODES_PER_FILE = 4000                 # 每个 yaml 最多多少节点，超过自动拆分
