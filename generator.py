...
TEMPLATE_FILE: Optional[Path] = Path("nodes/vless/003.txt") # 例如 Path("nodes/vmess/001.txt")，None 表示自动扫描  nodes/trojan/001.txt    nodes/vmess/001.txt  nodes/vless/001.txt nodes/vless/002.txt
